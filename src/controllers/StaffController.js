...
export const updateStaff = async (req, res) => {
  try {
    ...
    // Department
    if (department_en !== undefined) staff.department.en = department_en;

    if (department_hi !== undefined) staff.department.hi = department_hi;

    // Staff Name
    if (staffName_en !== undefined) staff.staffName.en = staffName_en;

    if (staffName_hi !== undefined) staff.staffName.hi = staffName_hi;

    // Designation
    if (designation_en !== undefined) staff.designation.en = designation_en;

    if (designation_hi !== undefined) staff.designation.hi = designation_hi;
    ...
    if (displayOrder !== undefined) {
      staff.displayOrder = Number(displayOrder);
    }

    // Education
    if (education_en !== undefined) staff.education.en = education_en;

    if (education_hi !== undefined) staff.education.hi = education_hi;

    // Image title
    if (imageTitle !== undefined) staff.imageTitle = imageTitle;

    // Research
    if (research_en !== undefined || research_hi !== undefined) {
      staff.Research = {
    ...
    // Publications
    if (publications_en !== undefined || publications_hi !== undefined) {
      staff.Publications = {
